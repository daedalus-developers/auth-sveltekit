<div class="container prose max-w-7xl py-8 dark:prose-invert">
	...
	<ul>
		...
		<li>
			<p>
				...
				or &quot;Our&quot; in this Agreement) refers to Auth Kit.
			</p>
		</li>
		<li>
			<p>
		...
		<li>
			<p>
				<strong>Website</strong> refers to Auth Kit, accessible from
				<a href="https://auth-kit.mkra.dev" rel="external nofollow noopener" target="_blank"
					>https://auth-kit.mkra.dev</a
				>
			</p>
		</li>
		<li>
	...
	<ul>
		<li>By email: support@mkra.dev</li>
	</ul>
</div>
